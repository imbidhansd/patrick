<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::select('mile_range', config('config.mile_options'), null, ['class' => 'form-control custom-select', 'placeholder' => 'Mile Range', 'required' => true]) !!}
        </div>
    </div>
</div>
<hr />
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="radio radio-primary radio-circle">
                <input type="radio" name="when_send" class="when_send" value="now" id="send_now" data-parsley-errors-container="#when_send_error_container" required />
                <label for="send_now">Now</label>
            </div>

            <div class="radio radio-primary radio-circle">
                <input type="radio" name="when_send" class="when_send" value="later" id="send_later" data-parsley-errors-container="#when_send_error_container" required />
    ...
    <div class="col-md-6" id="send_later_datetime" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('send_datetime', null, ['class' => 'form-control', 'id' => 'send_datetime', 'placeholder' => 'MM/DD/YYYY HH:II', 'data-toggle' => 'input-mask', 'data-mask-format' => '00/00/0000 00:00']) !!}
