...
<div class="card-box">
    <div class="row">
        <?php /* <div class="col-md-6">
          ...
          {!! Form::label('Category') !!}
          {!! Form::select('category_id', $categories , $category_id, ['class' => 'form-control custom-select', 'placeholder' => 'Select Category', 'id' => 'category_id']) !!}
          </div>
          </div> */ ?>
...
<script type="text/javascript">
    $(function () {
      ...
      $('#category_id').change(function () {
          if ($(this).val() != '') {
              window.location.href = '{{ url("apple-bitcoin/re-order/faqs") }}/' + $(this).val();
          }
      });
      ...
      $('.list-group-sortable').sortable({
          ...
          $.ajax({
              type: 'POST',
              url: '{{ url("admin/re-order/". $url_key) }}',
