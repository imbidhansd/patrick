        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $row->coupon_type->title }}</td>
                    <td>{{ number_format($row->coupon_amount, 2) }}</td>
                    <td>{{ $row->product->title }}</td>
                    <td>{{ $row->usage_limit }}</td>
                    <?php /* <td>{{ \Carbon\Carbon::createFromFormat(env('DB_DATE_FORMAT'), $row->expiration_date)->format(env('DATE_FORMAT')) }}</td> */ ?>
                    <td>{{ \App\Models\Custom::date_formats($row->expiration_date, env('DB_DATE_FORMAT'), env('DATE_FORMAT')) }}</td>
                    <td>
