...
<div class="col-md-6">
    <div class="text-center card-box">
        <div class="member-card">
            ...
            <button type="button" class="btn btn-primary mt-3 btn-rounded btn-bordered waves-effect width-md waves-light f_btn_round" data-toggle="modal" data-target="#editOwnerModal{{ $num }}">Edit</button>
            ...
            <div class="modal fade" id="editOwnerModal{{ $num }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content ">
                        ...
                        {!! Form::open(['url' => 'admin/companies/update-company-profile', 'class' => 'module_form update_company_profile_form']) !!}

                        {!! Form::hidden('company_id', $company_item->id) !!}
                        {!! Form::hidden('update_type', 'company_owner_info') !!}
                        
                        {!! Form::hidden('owner_id', $num) !!}
