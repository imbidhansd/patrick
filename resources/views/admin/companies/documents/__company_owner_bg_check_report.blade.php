    ...
    <div class="card card-border {{ $card_psrf_cls }}">
        <div class="card-header {{ $card_psrf_header_cls }} bg-transparent">
            <h3 class="card-title {{ $card_psrf_text_cls }} mb-0">
                {{ $company_information->$company_owner->first_name }} {{ $company_information->$company_owner->last_name }} BG/Credit Check/Prescreen Submittal
            </h3>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 text-center">
                    ...
                    <a data-fancybox="gallery_{{ $document_type }}" href="{{ route('secure.file', ['path' => 'media/'.$pre_screen_questions->bg_check_pdf->file_name]) }}" data-toggle="tooltip" data-placement="bottom" data-original-title="BG Check Question File">
                ...
                <div class="col-md-6 text-center">
                    ...
                    href="{{ route('secure.file', ['path' => 'media/'.$pre_screen_questions->pre_screen_question_file->file_name]) }}" data-toggle="tooltip" data-placement="bottom" data-original-title="Pre Screen Question File">
                        <i class="far fa-file-pdf font-50"></i>
                    </a>
                    <?php /* <br />
            ...
            @if (is_null($pre_screen_questions))
...
<div class="col-md-4">
    <div class="card card-border {{ $card_psrf_cls }}">
        <div class="card-header {{ $card_psrf_header_cls }} bg-transparent">
            <h3 class="card-title {{ $card_psrf_text_cls }} mb-0">
                {{ $company_information->$company_owner->first_name }} {{ $company_information->$company_owner->last_name }} BG/Credit Check Report
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <a data-fancybox="gallery_{{ $document_type }}"
                href="{{ route('secure.file', ['path' => 'media/'.$company_information->$company_owner->bg_check_report->media->file_name]) }}">
                <i class="far fa-file-pdf font-50"></i>
            </a>
        ...
        <div class="card-footer bg-transparent border-0">
            <div class="row">
                <div class="col-md-6">
                    ...
                    href="{{ route('secure.file', ['path' => 'media/'.$company_information->$company_owner->bg_check_report->media->file_name]) }}" download> <i class="far fa-file-pdf"></i> &nbsp; Download </a>
                </div>
