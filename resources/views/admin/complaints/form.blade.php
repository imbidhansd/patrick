<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('Company') !!}
            {!! Form::text('company_name', (isset($formObj) ? $formObj->company->company_name : null), ['class' => 'form-control', 'id' => 'company', 'placeholder' => 'Select Company', 'required' => true]) !!}
...
<div class="row">
    ...
    @if (isset($formObj) && count($formObj->complaint_files) > 0)
    <div class="col-md-12">
        <div class="form-group">
            <div class="row">
