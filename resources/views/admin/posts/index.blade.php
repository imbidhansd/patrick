        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th>{!! \App\Models\Custom::getSortingLink($module_urls['list'], 'Category', 'post_categories.title',
                        $list_params['sort_by'], $list_params['sort_order'], $list_params['search_field'],
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">View {{ $module_singular_name }}
                                        </h5>
