        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    {!! Form::select('dispute_status', ['in process' => 'In Process', 'approved' => 'Approved', 'declined' => 'Declined'], null, ['class' => 'form-control custom-select', 'id' => 'dispute_status', 'required' => true]) !!}
                </div>
                
                <div class="form-group" id="dispute_decline_reason" style="display: none;">
                    {!! Form::label('Dispute Decline Reason') !!}
                    {!! Form::textarea('dispute_decline_reason', null, ['class' => 'form-control']) !!}
                </div>
            </div>
            <div class="modal-footer">
...
<script type="text/javascript">
    $(function () {
        $(".reset_button").attr("href", '{{ url("admin/leads/open-disputes") }}');
        ...
        $("#dispute_status").on("change", function (){
            if ($(this).val() == 'declined'){
                $("#dispute_decline_reason").show();
                $("#dispute_decline_reason textarea").attr("required", true);
            } else {
                $("#dispute_decline_reason").hide();
                $("#dispute_decline_reason textarea").attr("required", false);
            }
        });
