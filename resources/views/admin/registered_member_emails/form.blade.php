...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            @php
            if (isset($formObj)){
            $mail_variables = config('new_email_keywords.registered_members.'.$formObj->email_type);
            } else {
            $mail_variables = config('new_email_keywords.registered_members.followup_email');
            }
            @endphp
