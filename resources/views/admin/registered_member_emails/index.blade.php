                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group btn-group-solid">
                                <a title="Send Test Emails" href="javascript:;" class="btn btn-orange btn-xs send_test_email" data-type="registered_member_emails" data-id="{{ $confirmation_email->id }}"><i class="fas fa-envelope"></i></a>
        ...
        <div class="table-responsive">
            <table class="table table-colored-bordered table-bordered-teal">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="btn-group btn-group-solid">
                            <a title="Send Test Emails" href="javascript:;" class="btn btn-orange btn-xs send_test_email" data-type="registered_member_emails" data-id="{{ $follow_up_mail_item->id }}"><i class="fas fa-envelope"></i></a>
