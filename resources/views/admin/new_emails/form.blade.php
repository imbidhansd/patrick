<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('Title') !!}
            {!! Form::text('title', null, ['class' => 'form-control max', 'id' => 'email_title', 'placeholder' => 'Enter Title', 'required' => true, 'maxlength' => 255, 'readonly' => $readonly]) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::select('email_for', $email_for, null, ['class' => 'form-control custom-select', 'id' => 'email_for', 'required' => 'required']) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::select('email_type', $email_type, null, ['class' => 'form-control custom-select', 'placeholder' => 'Select Email Type', 'required' => true]) !!}
        </div>
    </div>
    @endif
</div>
    ...
    $(function () {
        $("#email_type").on("change", function () {
            ...
            if (typeof email_title !== 'undefined' && email_title != '') {
                $.ajax({
                    url: '{{ url("admin/new_emails/get-email-variables") }}',
                    type: 'POST',
