<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('Subject') !!}
            {!! Form::text('subject', null, ['class' => 'form-control max', 'placeholder' => 'Enter Subject', 'required' => true, 'maxlength' => 255]) !!}
        </div>
    </div>
</div>
...
<?php /* <div class="row">
  ...
  <div class="form-group">
  {!! Form::label('Header Content') !!}
  {!! Form::textarea('email_header', ((isset($default_email)) ? $default_email->email_header : null), ['class'
  => 'form-control ckeditor']) !!}
  </div>
  </div>
  </div>
  @if (isset($formObj) && $formObj->email_type == 'confirmation_email')
  {!! Form::hidden('email_header', null) !!}
  @else
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            @php
            $mail_variables = config('follow_up_email_keywords.content');
            @endphp
...
<div class="row">
    @if (isset($formObj) && $formObj->email_type == 'confirmation_email')
    {!! Form::hidden('send_time', '0 Seconds') !!}
    @else
    <div class="col-md-6">
        <div class="row">
            <div class="col-md-6">
    ...
    {!! Form::hidden('email_for', 'Site User') !!}
    <?php /* <div class="col-md-3">
      <div class="form-group">
      {!! Form::label('Email For') !!}
      <div class="select">
      {!! Form::select('email_for', ['Site User' => 'Site User', 'Company' => 'Company', 'Admin' => 'Admin'], null, ['class' => 'form-control custom-select', 'required' => 'required']) !!}
      </div>
      </div>
      </div> */ ?>
