    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('artwork_type', $artworkTypeArr , $artworkTypeId, ['class' => 'form-control custom-select', 'placeholder' => 'Select Artwork Type', 'id' => 'artwork_type']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <section>
                ...
                <ul class="list-group list-group-sortable">
                    ...
                    <li id='{{ $row->id }}' class="list-group-item"><i class="fa fa-bars reorder-icon"></i> {{ $row->title }}</li>
                    @endforeach
                </ul>
            </section>
