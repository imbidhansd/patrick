...
<li
    ...
    <a href="javascript:;" data-toggle="modal" data-target="#stateLicensingStatusModal">State Licensing</a>
...
@if ($company_approval_status->state_licensing == 'pending' || $company_approval_status->state_licensing == 'in process')
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content ">
            ...
            <div class="modal-body text-left">
                <p class="text-center font-15">Your state licensing has not yet been received. Please upload a copy of your state license.</p>
...
@if ($company_approval_status->state_licensing == 'in process' || $company_approval_status->state_licensing == 'completed')
<div class="modal fade" id="stateLicensingStatusModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content ">
            <div class="modal-header text-center">
            ...
            <div class="modal-body text-center">
                ...
                <p class="font-15">Your state licenses are being reviewed.</p>
                @else
                <p class="font-15 font-bold">Your state licenses have been uploaded.</p>
                @endif
                ...
                <div class="btn-group btn-group-solid">
                    ...
                    <a class="btn btn-success btn-sm" href="{{ route('secure.file.company', ['path' => 'media/'.$company_licensing->state_licensed_file->media->file_name]) }}" download> <i class="far fa-file-pdf"></i> &nbsp; Download </a>
                    @endif

                    @if ($company_approval_status->state_licensing == 'in process')
                    <a href="javascript:;" class="btn btn-primary btn-sm close_current_modal" data-toggle="modal" data-target="#stateLicensingModal">Upload Another File</a>
                    @endif
                </div>
            </div>
        </div>
