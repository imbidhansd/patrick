{!! Form::open(['url' => 'account/upgrade/step5','id' => 'step5_form', 'class' => 'module_form', 'files' => true]) !!}
                ...
                if ($('#secondary_main_category_id option').length >= 3) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('.chk_service_category_id_step_6').each(function(){
                                //console.log (Math.random() + ' ' + $(this).is(':checked'));
                                if ($(this).is(':checked') == true){
                                    $(this).closest('.service_category_item_list').removeClass('d-none');
                                    $(this).closest('.chk_main_cat').find('.chk_all').attr('checked', true);
                                }
                            });


                            if ($('#include_rest_categories_no').is(':checked') == true){
