...
<li
    ...
    @if ($company_approval_status->background_check_pre_screen_fees == 'completed')
	    <a href="javascript:;" data-toggle="modal" data-target="#backgroundCheckFeeModal">Background Check Pre Screen Fees</a>
		    ...
		    <div class="modal-dialog modal-md" role="document">
		        <div class="modal-content ">
		            <div class="modal-header text-center">
		                <h4 class="modal-title w-100 font-weight-bold text-left">Background Check/Pre-Screen Fee</h4>
		            ...
		            <div class="modal-body text-center">
		            	<h4>Background Check/Pre-Screening Fees were paid on {{ (!is_null($company_invoice_detail)) ? $company_invoice_detail->invoice_date : '' }}!</h4>
    ...
    @else
    Background Check Pre Screen Fees
    @endif
