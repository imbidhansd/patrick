...
<li
    ...
    @if ($company_approval_status->country_licensing == 'pending')
        <a href="javascript:;" data-toggle="modal" data-target="#countryLicensingModal">Country Licensing</a>
...
@if ($company_approval_status->country_licensing == 'pending' || $company_approval_status->country_licensing == 'completed')
<div class="modal fade" id="countryLicensingModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content ">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold text-left">Country Licensing</h4>
            ...
            @elseif ($company_approval_status->country_licensing == 'completed')
                <div class="modal-body text-center">
                    <h4>Your Country Licensing File has been received!</h4>
