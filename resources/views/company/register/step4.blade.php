{!! Form::open(['url' => 'register/step4','id' => 'step4_form', 'class' => 'module_form', 'files' => true]) !!}
...
<button type="submit" class="btn btn-info float-md-right last_input step4_submit btn-bg-default">Save & Next</button>
