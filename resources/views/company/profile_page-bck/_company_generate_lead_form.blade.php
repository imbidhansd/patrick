    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <div class="text-center">
                ...
                <h3 class="text-uppercase blue-font">Request a free estimate from {{ $companyObj->showCompanyName() }}</h3>
                @else
                <h3 class="text-uppercase blue-font">Request to be contacted by {{ $companyObj->showCompanyName() }}</h3>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12 text-right">
            <div class="checkbox checkbox-primary checkbox-circle">
                ...
                <label for="lead_terms">By submitting this request, you are agree to our <a href="javascript:;" data-toggle="modal" data-target="#termsModal">Terms Of Use</a></label>
            </div>
            <div id="lead_terms_error"></div>
        </div>

        <div class="col-lg-12 text-right">
            <button type="submit" class="btn btn-primary btn-sm generate_lead_btn">Submit Request</button>
        </div>
    </div>
...
@push('page_script')
@include ('admin.includes.captcha_js', ['action_field' => 'generate_lead'])
<!-- Plugins js -->
