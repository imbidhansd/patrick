...
class CompanyLeadStatusController extends Controller {

    public function pauseleads() {
        ...
        echo 'Company Leads pause completed successfully.';
    }

    public function startleads() {
        $web_settings = Custom::getSettings();
        $companyObj = Company::with('membership_level')
        ...
        echo 'Company Leads start completed successfully.';
    }
