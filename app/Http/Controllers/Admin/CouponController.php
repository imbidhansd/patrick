...
class CouponController extends Controller {
    ...
    public function __construct() {
        ...
        $this->common_data = [
            ...
            'coupon_types' => CouponType::active()->order()->pluck('title', 'id'),
            'products' => Product::active()->order()->pluck('title', 'id')
        ];
        ...
        $data = [
            ...
            'search' => [
                'coupons.coupon_type_id' => [
                    'title' => 'Coupon type',
                    'options' => $this->common_data['coupon_types'],
                    'id' => 'coupon_type_id'
                ],
                'coupons.product_id' => [
                    'title' => 'Product',
                    'options' => $this->common_data['products'],
                    'id' => 'product_id'
                ],
            ]
        ];
    ...
    public function edit($id) {
        ...
        if (!is_null($formObj->expiration_date)) {
            $data['formObj']->expiration_date = Custom::date_formats($formObj->expiration_date, env('DB_DATE_FORMAT'), env('DATE_FORMAT'));
        }
