...
class NonMemberFollowUpMail extends Mailable {
    ...
    public function build() {
        $emailObj = NonMemberEmail::find($this->email_id);


        $footer_variables = config('common_email_keywords');
        $followup_variables = config('new_email_keywords.non_members.' . $emailObj->email_type);
